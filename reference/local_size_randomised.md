...
[`local_size_modified()`](local_size_modified.md), which applies a
\\\gamma_0\\ threshold and returns 0 or 1 at the boundary, this function
uses \\\gamma_1\\ and \\\gamma_2\\ directly as rejection probabilities,
reflecting the true expected size of the randomised test.
